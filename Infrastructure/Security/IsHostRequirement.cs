...
namespace Infrastructure.Security
{
    ...
    public class IsHostRequirementHandler : AuthorizationHandler<IsHostRequirement>
    {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext aContext, IsHostRequirement requirement)
        {
            if (aContext.Resource is AuthorizationFilterContext authContext)
            {
                ...
                if (host?.AppUser?.UserName == currentUserName) aContext.Succeed(requirement);
            }
            else aContext.Fail();
